...
/// anything that isn't a conservative SQL identifier before it reaches
/// `quote_ident`.
///
...
/// SQL identifier without escaping concerns. This is stricter than either
/// Postgres or SQLite actually require, but column and table names generated
/// by `db_tool_planner` will always match this pattern; hand-edited manifests
